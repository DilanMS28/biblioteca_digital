    ...
    return (
        <>
            <div className="max-w-[1200px] mx-auto">
                ...
                <div className="p-8">
                    <h1 className="text-7xl font-bold text-center text-slate-900 mb-2">Registrarse</h1>
                    <p className="text-lg text-slate-600 leading-relaxed text-center">Crea una cuenta con tus datos</p>
                </div>
